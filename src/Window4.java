...
public class Window4 extends Application {
    ...
    Window5 window_5 = new Window5();
    YouLost youLost = new YouLost();

    public void start(Stage fourthStage) {

        HBox questionBox = Builder.instance.returnQuestion("Hvor mange delstater er det i USA?");

        //Button answer-options
        ArrayList<Button> buttonArray = Builder.instance.returnButtons(4, 90, 20);
        buttonArray.get(0).setText("50");
        buttonArray.get(1).setText("53");
        buttonArray.get(2).setText("52");
        buttonArray.get(3).setText("51");
        ...
        fourthStage.setScene(new Scene(border, 600, 300));
